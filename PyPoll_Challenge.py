...
# Challenge code *~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~* *Confirmed Works*
...
# CHallenge code *~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*
#Track the votes for the largest county
largestcounty = ""
largestcount = 0
# Challenge code *~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*
...
# Challenge Code *~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~* *Confirmed works*
        ...
        county_name = row[1]
        # If the county does not match any existing county, add the county
        # to the county list
        if county_name not in county_options:
            # Add the county name to the county list.
            county_options.append(county_name)
            # Tracking that county's votes
            county_votes[county_name] = 0
        # Add a vote to that county's count.
        county_votes[county_name] += 1
# Challenge Code End *~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~* *Confirmed works*
...
#Challenge Code *~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~* *confirmed works
    # Write information onto txt_file
...
#CHallenge Code End/Start *~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~ *confirmed works
        # Write information onto txt_file
    ...
    #print largest voter turnout to the terminal
    largestcountsummary = (
        f"\n-------------------------\n"
        f"Largest County Turnout: {largestcounty}\n"
        f"-------------------------\n"
    ) 
    print(largestcountsummary)
    

#Challenge Code End *~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*

    # Save the final vote count to the text file.
    txt_file.write(largestcountsummary)
